...
N. negative coefficients expenditure: 16/31 = `r round(16/31 * 100, 1)`%
...
N. negative coefficients expenditure: 16/27 = `r round(16/27 * 100, 1)`%

N. significant coefficients expenditure: 12/27 = `r round(12/27 * 100, 1)`%
...
N. negative coefficients expenditure: 14/31 = `r round(14/31 * 100, 1)`%

N. significant coefficients expenditure: 17/31 = `r round(17/31 * 100, 1)`%
...
N. negative coefficients expenditure: 22/37 = `r round(22/37 * 100, 1)`%
...
N. significant coefficients expenditure: 26/37 = `r round(26/37 * 100, 1)`%
...
Should interpretation of the positive poor dummies that policies are working better in those regions?
